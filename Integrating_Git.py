...
class View(tk.Frame):
    ...
    def __init__(self, *args, **kwargs):
        ...
        url1 = "https://raw.githubusercontent.com/mziauddin/Bibtex-File-Comparison-and-Update/master/bibtex.bib"
        directory = getcwd()
        filename1 = 'File_01.bib'
        r = requests.get(url1)
        
        f1 = open(filename1,'w')
        f1.write(r.content)
        
        url2 = "https://raw.githubusercontent.com/mziauddin/Bibtex-File-Comparison-and-Update/master/bibtex.bib"
        directory = getcwd()
        filename2 = 'File_02.bib'
        r = requests.get(url2)
        
        f2 = open(filename2,'w')
        f2.write(r.content)        
        
        local_file.set(filename1)
        master_file.set(filename2)
